// app/tvscreen/page.tsx
'use client';

import React, { useState, useEffect } from 'react';
import Link from 'next/link';
import { Calendar, MapPin, Users, Trophy, Clock, ArrowRight, Monitor } from 'lucide-react';
...
export default function TVScreenSelectPage() {
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <div className="flex items-center justify-center gap-3 mb-2">
                        ...
                        <h1 className="text-4xl font-bold text-cyan-300 drop-shadow-[0_0_10px_rgba(6,182,212,0.5)]">
                            TV Screen Display
                        </h1>
                    </div>
                    <p className="text-gray-400">
                        Select a tournament to display on the TV screen
                    </p>
                </div>
