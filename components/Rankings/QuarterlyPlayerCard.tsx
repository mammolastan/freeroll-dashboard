...
import { Zap, Hexagon, LandPlot, Calculator, Star } from "lucide-react";
...
export function QuarterlyPlayerCard({
  player,
  isFavorite,
  onToggleFavorite,
}: QuarterlyPlayerCardProps) {
  ...
  return (
    <div
      className={`playerCardContainer ${player.isQualified ? "qualified" : ""}`}
    >
